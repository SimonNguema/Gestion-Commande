          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong style="font-size: 30px;">{{ $commande->montant }}FCFA</strong></li>
...
@endforeach
        ...
        <div class="text-center">
              ...
              <div class="card-body">
                 <a href="{{route('panier.index')}}"> <button type="button" class="btn btn-warning btn-block btn-lg">Retour au panier</button></a>
              </div>
